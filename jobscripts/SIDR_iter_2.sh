...
python connect.py create input/SIDR_iter_2.param

cd resources/montepython_public/

srun --mpi=none --ntasks=4 --cpus-per-task=1 \
  python montepython/MontePython.py run \
  -p /home/jthybo/connect_wsl/mcmc_plugin/mp_param_templates/SIDR_iter_2.param \
