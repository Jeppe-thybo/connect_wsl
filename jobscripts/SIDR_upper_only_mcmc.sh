#!/bin/bash
#SBATCH --job-name=SIDR_upper_only
#SBATCH --partition=qany
#SBATCH --mem-per-cpu=3g
#SBATCH --ntasks=6
#SBATCH --cpus-per-task=1
#SBATCH --time=48:00:00
#SBATCH --output=SIDR_upper_only_mcmc.out
...
srun --mpi=none --ntasks=6 --cpus-per-task=1 \
  ...
  -p /home/jthybo/connect_wsl/mcmc_plugin/mp_param_templates/SIDR_upper_only.param \
