#!/bin/bash
#SBATCH --job-name=SIDR_interacting_and_std_magnus
...
#SBATCH --output=SIDR_interacting_and_std_magnus.out
...
python connect.py create input/SIDR_interacting_and_std_magnus.param
