#!/bin/bash
#SBATCH --job-name=SIDR_model_iter_mcmc
#SBATCH --partition=qany
#SBATCH --mem-per-cpu=2g
#SBATCH --ntasks=4
#SBATCH --cpus-per-task=1
#SBATCH --time=48:00:00
#SBATCH --output=SIDR_model_iter_mcmc.out
...
srun --mpi=none --ntasks=4 --cpus-per-task=1 \
  ...
  -p /home/jthybo/connect_wsl/mcmc_plugin/mp_param_templates/SIDR_model_iter.param \
