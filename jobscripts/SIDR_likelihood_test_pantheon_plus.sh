#!/bin/bash
#SBATCH --job-name=SIDR_likelihood_test_pantheon_plus
#SBATCH --partition=q48
#SBATCH --mem-per-cpu=3g
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --time=48:00:00
#SBATCH --output=SIDR_likelihood_test_pantheon_plus_mcmc.out
...
python -u montepython/MontePython.py run \
  -p /home/jthybo/connect_wsl/mcmc_plugin/mp_param_templates/SIDR_likelihood_test_pantheon_plus.param \
  ...
  -o chains/SIDR_likelihood_test_pantheon_plus \
  --chain-number 1 \
